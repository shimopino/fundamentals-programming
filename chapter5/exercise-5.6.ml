...
let kyosukai a b c = 
    hanbetsusiki a b c < 0.0 ;;

let test4 = kyosukai 1.0 5.0 4.0 = false ;; 
let test5 = kyosukai 2.0 (-4.0) 2.0 = false ;;
let test6 = kyosukai 1.0 2.0 4.0 = true ;;
